...
The best means of prevention is through education, which is why I created a [web page](https://sharozofficial.github.io/Project2/) containing links to resources related to each cardiovascular disease risk indicator. 
